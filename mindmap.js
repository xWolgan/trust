function initMindmap() {
    ...
    { id: 1, label: "TRUST", title: "This is the main topic", description: "this is Main topic description", color: "#8B4513", shape: "circle", size: 80, x: -300, y: 0, font: { color: '#FFFFFF' }, },
